...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "checkout_process", name = "Checkout_process", hidden = true)
@ProcessInput(processName = "checkout_process")
public class Checkout_processModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<Checkout_processModel> {
    ...
    @Override()
    public Checkout_processModel toModel() {
        Checkout_processModel result = new Checkout_processModel();
